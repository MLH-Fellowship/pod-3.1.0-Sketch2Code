...
Our prime motive was to provide automation in App Development at its extreme level of ease. So what could be better than this method where user need to provide Sketch of UI and code will be autogenerated. This is how Sketch 2 Code was made into eixtence.

Later when we realised that it was not easy for all to draw Sketch of UI and provide it we thought to bring Text 2 Code. So Text 2 Code is a more easier way where user needs to provide their requirements and the code wil be generated.
